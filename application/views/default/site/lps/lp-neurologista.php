...
<style>
    ...
    <!-- Banner -->
    <div class="bg-lp-cardiologia-secao-1" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-neuro/banner.png'); ">
        ...
        <div class="topo" style="position: relative">
            <div class="centraliza">
                <div class="col-2" style="margin-top: 100px; margin-right: 50px">
                    ...
                    <h1 style="color: white;font-size: 40px;">PROCURANDO<br>NEUROLOGISTA?</h1><br>
    ...
    <div style="width: 100%;display: none">
        ...
        <div class="col-2">
            <div class="bg-preco-ginecologista" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-neuro/tabela.png');"></div>
            <div style="height: 300px;margin-bottom: 20px;margin-right: 10px;background-repeat: no-repeat;background-position: center;background-size: contain; background-image: url('<?= base_url() ?>arquivos/assets/img/lp-neuro/bg-print.png');"></div>
        </div>
        ...
        <div class="col-2">
            ...
            <div id="preco-img" style="height: auto; background-color: #02428e;padding: 80px; color: #ffffff;">
                <div class="img-preco-oftalmo" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-neuro/preco.png');"></div>
        ...
        <div class="col-2">
            <div style="height: auto; background-color: #0094d6">
                <h2 class="texto-voce-sabia">
                    É importante agendar sua consulta com um neurologista caso você apresente dores de cabeça, tontura, dormência ou formigamento, fraqueza, convulsões, problemas na visão, problemas de memória ou até mesmo problemas de sono.
                </h2>
            </div>
        </div>
        <div class="col-2">
