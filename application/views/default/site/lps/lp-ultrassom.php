...
/>
    ...
    <!-- Banner -->
    <div class="bg-lp-cardiologia-secao-1" style="margin-top: 70px;background-image: url('<?= base_url() ?>arquivos/assets/img/lp-ultrassom/banner.png'); ">
        ...
        <div class="topo" style="position: relative">
            <div class="centraliza">
                <div class="col-2" style="margin-top: 100px; margin-right: 50px">
                    ...
                    <h1 style="color: white;font-size: 40px;">PROCURANDO<br>EXAME DE ULTRASSOM?</h1><br>
                    <h2 style="color: white">Se você chegou até aqui é porque algo em sua saúde está te preocupando.</h2><br>
                    <h3 style="display: none; color: white;margin-right: 60px;">A partir de agora deixe conosco, que vamos cuidar de você e da sua saúde. Garantindo o melhor diagnóstico pelo menor preço!</h3><br>
                    <br>
                    <br>
                    <div class="pulsando">
    ...
    <div style="width: 100%; display:none">
        ...
        <div class="col-2">
            <div class="bg-preco-ginecologista" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-ultrassom/tabela.png');"></div>
        </div>
        ...
        <div class="col-2">
            ...
            <div id="preco-img" style="height: auto; background-color: #02428e;padding: 80px; color: #ffffff;">
                    <div class="img-preco-oftalmo" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-ultrassom/preco.png');"></div>
                </div>
