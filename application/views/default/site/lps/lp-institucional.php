...
<style>
    ...
    @media only screen and (max-width: 425px) {
        ...
        .titulo-banner { font-size: 30px !important; }

        .alinhar-contato { width: 200% !important; position: relative; left: -40px; }

        .texto-voce-sabia { padding: 20px !important; }
    }

</style>
<!-- Banner -->
<div class="bg-lp-cardiologia-secao-1" style="background-color: #003D71; background-image: url('<?= base_url() ?>arquivos/assets/img/lp-institucional/bg-secao1.png'); ">
    ...
    <div class="topo" style="position: relative">
        <div class="centraliza">
            <div class="col-2" style="margin-top: 100px; margin-right: 50px">
                ...
                <h1 class="titulo-banner" style="color: white;font-size: 50px;">SE VOCÊ CHEGOU ATÉ AQUI É PORQUE ALGO EM SUA SAÚDE ESTÁ TE PREOCUPANDO.</h1><br>
                <h3 style="color: white;margin-right: 60px;font-weight: 100;">A partir de agora deixe conosco, que vamos cuidar de você e da sua saúde.</h3><br>
                <h3 style="color: white;margin-right: 60px;font-weight: bold;">CLIQUE ABAIXO PARA AGENDAR GRATUITAMENTE</h3><br>
                <a href="https://wa.me/5514981610303" style="width: 100%; background: transparent; border: 0px;">
                    <div style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-institucional/botoes.png'); height: 141px;background-size: contain;background-position: left;background-repeat: no-repeat;margin-bottom: 50px;"></div>
                </a>
            </div>
            <div class="clear"></div>
        </div>
...
<div style="width: 100%; height: auto; background-color: #FFF">
    <div class="centraliza">
        <div class="centraliza-itens">
            <div style="margin-top: 30px; margin-bottom: 30px" class="col-3">
                <img width="100%" src="<?= base_url() ?>arquivos/assets/img/lp-institucional/20-especialidades.png"><br>
            </div>
            <div style="margin-top: 30px; margin-bottom: 30px" class="col-3">
                <img width="100%" src="<?= base_url() ?>arquivos/assets/img/lp-institucional/Especialidade.png"><br>
            </div>
            <div style="margin-top: 30px; margin-bottom: 30px" class="col-3">
                <img  width="100%" src="<?= base_url() ?>arquivos/assets/img/lp-institucional/Consultas.png"><br>
            </div>
            <div>
                <img style="margin-bottom: 50px; margin-top: 50px" width="100%" src="<?= base_url() ?>arquivos/assets/img/lp-institucional/mensalidade.png"><br>
            </div>
            <div class="centraliza-itens" style="width: 100%; min-height: 150px">
                <div>
                    <a style="width: 300px;padding: 15px;font-size: 15px;background-color: #7F1114;border: 0px;border-radius: 10px;color: #fff;" class="animated infinite pulse" href="tel:+5514981610303"><img style="width: 20px; vertical-align: bottom;" src="<?= base_url(); ?>arquivos/assets/img/icone-telefone-branco.png">  LIGUE AGORA PARA AGENDAR! </a>
                    <br>
                    <br>
                    <br>
                    <a style="width: 300px;padding: 15px;font-size: 15px;background-color: #7F1114;border: 0px;border-radius: 10px;color: #fff;" class="animated infinite pulse" href="https://wa.me/5514981610303"><img style="width: 20px; vertical-align: bottom;" src="<?= base_url(); ?>arquivos/assets/img/icone-whats-branco.png">&nbsp;  AGENDE AGORA MESMO! </a>
                </div>
            </div>
        </div>
    </div>
...
<div class="rodape-fixo" style="display: none; position: fixed;bottom: 0px;left: 0px;width: 100%;z-index: 99; background-color: #27448a">
    <div style="padding: 20px" class="centraliza-itens">
        <button onclick="ModalLps('abre')" class="animated infinite pulse btn-alinhar" style="width: 160px !important;padding: 17px !important;font-size: 13px !important;background-color: #c20e1a !important;border: 0px !important; border-radius: 10px !important;color: #ffffff !important;"> AGENDE JÁ! </button>
    </div>
</div>
