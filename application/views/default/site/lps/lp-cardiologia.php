<?php $this->load->view("default/site/include/header-lp"); ?>
    ...
    <div style="width: 100%;">
        ...
        <div class="col-2">
            <div class="bg-preco-ginecologista" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-cardiologia/tabela.png');"></div>
            <div style="height: 300px;margin-bottom: 20px;margin-right: 10px;background-repeat: no-repeat;background-position: center;background-size: contain; background-image: url('<?= base_url() ?>arquivos/assets/img/lp-cardiologia/print.png');"></div>
        </div>
    ...
    <div style="width: 100%; height: auto; background-color: #013069">
        ...
        <div class="centraliza">
            ...
            <div style="margin-bottom: 30px; margin-top: 25px;height: auto; background-color: #013069">
                ...
                <div>
                    <a style="text-decoration: none;" href="tel:5508005809771">
