    ...
    <div class="topo" style="position: relative">
        <div class="centraliza">
            <div class="col-2" style="margin-top: 100px; margin-right: 50px">
                ...
                <h1 style="color: white;font-size: 40px;">PROCURANDO<br>CLÍNICO GERAL?</h1><br>
                ...
                <button onclick="ModalLps('abre')" style="width: 300px;padding: 20px;font-size: 15px;background-color: white;border: 0px;border-radius: 10px;color: #CE3F7D;" class="animated infinite pulse"> DEIXE CONTATO PARA LIGARMOS! </button>
            </div>
            <div class="clear"></div>
        </div>
    </div>
...
<div style="width: 100%;">
    ...
    <div class="col-2">
        ...
        <div style="height: auto; background-color: #ffffff">
            <div style="padding: 5px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
            ...
            <div style="padding: 5px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Hemograma</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$14,00</h3></div>
            </div>
            <hr style="margin-left: 80px;margin-right: 80px;margin-top: 20px;">
            <div style="padding: 5px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Exames Laboratoriais:</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center"></h3></div>
            </div>
            <hr style="margin-left: 80px;margin-right: 80px;margin-top: 20px;">
            <div style="padding: 5px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Glicose</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$15,00</h3></div>
            </div>
            <hr style="margin-left: 80px;margin-right: 80px;margin-top: 20px;">
            <div style="padding: 5px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">TGP</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$15,00</h3></div>
            </div>
            <hr style="margin-left: 80px;margin-right: 80px;margin-top: 20px;">
            <div style="padding: 5px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Colesterol total</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$45,00</h3></div>
            </div>
            <hr style="margin-left: 80px;margin-right: 80px;margin-top: 20px;">
            <div style="padding: 5px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Creatina</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$15,00</h3></div>
            </div>
            <hr style="margin-left: 80px;margin-right: 80px;margin-top: 20px;">
            <div style="padding: 5px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Fezes (sangue oculto)</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$16,00</h3></div>
            </div>
            <hr style="margin-left: 80px;margin-right: 80px;margin-top: 20px;">
            <div style="padding: 5px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Urina tipo 1</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$18,00</h3></div>
            </div>
            <hr style="margin-left: 80px;margin-right: 80px;margin-top: 20px;">
            <div style="padding: 5px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">TGO</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$20,00</h3></div>
            </div>
            <hr style="margin-left: 80px;margin-right: 80px;margin-top: 20px;">
            <div style="padding: 5px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
            ...
            <div class="clear"></div>
            <div style="padding: 5px;margin-top: 50px;" class="centraliza-itens">
                <div style="background-color: #c20e1a;height: auto;padding: 10px;width: 250px;border-radius: 25px;">
                    ...
                    <div class="col-2"><h3 style="color: #ffffff;margin-top: 10px;margin-bottom: 10px;" class="text-align-center">R$658,00</h3></div>
                </div>
            </div>
            <div class="clear"></div>
        </div>
...
<div style="width: 100%; height: auto; background-color: #013069">
    ...
    <div class="centraliza">
        ...
        <div style="margin-bottom: 30px; margin-top: 25px;height: auto; background-color: #013069">
            ...
            <div>
                ...
                <a style="text-decoration: none;" href="tel:5514997000922">
    ...
    <div style="margin-bottom: 95px;width: 100%; height: auto; background-color: #013473">
        <div class="centraliza-itens">
            <h2 style="padding: 50px 0px 50px 0px;" class="texto-voce-sabia">
