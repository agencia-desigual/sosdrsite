...
<div class="fundo-escuro centraliza-itens">
    <div class="conteudo">
                    ...
                    <div class="centraliza">
                        <div style="height: auto; margin-bottom: 50px" class="espaco-branco-form">
                            ...
                            <div class="espaco-form">
                                ...
                                <form id="formGanheConsulta2">
                                    <p class="label-form">NOME DO SEU AMIGO 1</p>
                                    <input class="input-form" type="text" name="nomeAmigo1" required>

                                    <br>
                                    <br>

                                    <p class="label-form">CELULAR DO SEU AMIGO 1</p>
                                    <input class="input-form celular" type="tel" name="celularAmigo1">

                                    <br>
                                    <br>

                                    <p class="label-form">NOME DO SEU AMIGO 2</p>
                                    <input class="input-form" type="text" name="nomeAmigo2" required>

                                    <br>
                                    <br>

                                    <p class="label-form">CELULAR DO SEU AMIGO 2</p>
                                    <input class="input-form celular" type="tel" name="celularAmigo2">

                                    <br>
                                    <br>

                                    <p class="label-form">NOME DO SEU AMIGO 3</p>
                                    <input class="input-form" type="text" name="nomeAmigo3" required>

                                    <br>
                                    <br>

                                    <p class="label-form">CELULAR DO SEU AMIGO 3</p>
                                    <input class="input-form celular" type="tel" name="celularAmigo3">

                                    <button id="btn_ganhar2" type="submit" class="btn-download-lp">QUERO GANHAR!</button>
