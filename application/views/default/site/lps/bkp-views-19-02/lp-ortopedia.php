...
<!-- Banner -->
<div class="bg-lp-cardiologia-secao-1" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-ortopedia/banner.png'); ">
    ...
    <div class="topo" style="position: relative">
        <div class="centraliza">
            <div class="col-2" style="margin-top: 100px; margin-right: 50px">
                ...
                <button onclick="ModalLps('abre')" style="width: 200px;padding: 20px;font-size: 15px;background-color: white;border: 0px;border-radius: 10px;color: #214794;" class="animated infinite pulse"> AGENDE JÁ! </button>
            </div>
            <div class="clear"></div>
        </div>
    </div>
...
<div style="width: 100%;">
    <div class="centraliza p-t-40 p-b-40">
       <div class="rolagem">
           <img src="<?= base_url() ?>arquivos/assets/img/lp-ortopedia/tabela.png" style="width: 1100px;" />
       </div> 
    </div>
</div>
<div class="clear"></div>
