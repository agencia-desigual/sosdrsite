<?php $this->load->view("default/site/include/header-lp"); ?>
    ...
    <!-- Banner -->
    <div class="bg-lp-cardiologia-secao-1" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-cardiologia/bg-secao1.jpg'); ">
        ...
        <div class="topo" style="position: relative">
            <div class="centraliza">
                <div class="col-2" style="margin-top: 100px; margin-right: 50px">
                    ...
                    <h1 style="color: white;font-size: 40px;">PROCURANDO<br>CARDIOLOGISTA?</h1><br>
    ...
    <div style="width: 100%;">
        ...
        <div class="col-2">
            ...
            <div style="height: auto; background-color: #ffffff">
                <div style="padding: 25px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                    <div class="col-2"><h3 style="color: #013575" class="text-align-center">Consulta Cardiologista</h3></div>
                    <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$800,00</h3></div>
                </div>
                ...
                <div style="padding: 25px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                    ...
                    <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$120,00</h3></div>
                </div>
                <div class="clear"></div>
                <div style="padding: 25px" class="centraliza-itens">
                    <div style="background-color: #c20e1a;height: auto;padding: 10px;width: 250px;border-radius: 25px;">
                        ...
                        <div class="col-2"><h3 style="color: #ffffff;margin-top: 10px;margin-bottom: 10px;" class="text-align-center">R$920,00</h3></div>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
        ...
        <div class="col-2">
            ...
            <div style="height: auto; background-color: #02428e;padding: 80px; color: #ffffff;">
                <h1>Consulta com Cardiologista</h1>
                <h1>+Eletrocardiograma</h1>
                <h1>+Retorno</h1>
                <div class="img-preco-oftalmo" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-cardiologia/preco-sos.png');"></div>
                <div style="width: 150%">
                    <a style="width: 300px;padding: 15px;font-size: 15px;background-color: white;border: 0px;border-radius: 10px;color: #7F1114;" class="animated infinite pulse" href="tel:+5514998361670"><img style="width: 20px; vertical-align: bottom;" src="<?= base_url(); ?>arquivos/assets/img/icone-telefone.png">  LIGUE AGORA PARA AGENDAR! </a>
                    <br>
                    <br>
