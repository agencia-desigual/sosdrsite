...
<!-- Banner -->
<div class="bg-lp-cardiologia-secao-1" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-psiquiatria/banner.png'); ">
    ...
    <div class="topo" style="position: relative">
        <div class="centraliza">
            <div class="col-2" style="margin-top: 100px; margin-right: 50px">
                ...
                <button onclick="ModalLps('abre')" style="width: 200px;padding: 20px;font-size: 15px;background-color: white;border: 0px;border-radius: 10px;color: #42c1c7;" class="animated infinite pulse"> AGENDE JÁ! </button>
            </div>
            <div class="clear"></div>
        </div>
    </div>
...
<div style="width: 100%;">
    ...
    <div class="col-2">
        ...
        <div style="height: auto; background-color: #ffffff">
            <div style="padding: 25px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Consulta Psiquiatra</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$220,00</h3></div>
            </div>
            <hr style="margin-left: 80px;margin-right: 80px;margin-top: 20px;">
            <div style="padding: 25px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Sessão Psicólogo</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$170,00</h3></div>
            </div>
            <hr style="margin-left: 80px;margin-right: 80px;margin-top: 20px;">
            <div style="padding: 25px; margin-bottom: 30px;margin-top: 10px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Retorno Psiquiatra</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$220,00</h3></div>
            </div>
            <div class="clear"></div>
            <div style="padding: 25px" class="centraliza-itens">
                <div style="background-color: #c20e1a;height: auto;padding: 10px;width: 250px;border-radius: 25px;">
                    ...
                    <div class="col-2"><h3 style="color: #ffffff;margin-top: 10px;margin-bottom: 10px;" class="text-align-center">R$410,00</h3></div>
                </div>
            </div>
            <div class="clear"></div>
        </div>
    ...
    <div class="col-2">
        ...
        <div style="height: auto; background-color: #02428e;padding: 80px; color: #ffffff;">
            <h1>Consulta Psiquiatra</h1>
            <h1>+ Sessão Psicólogo</h1>
            <h1>+ Retorno Psiquiatra</h1>
            <div class="img-preco-oftalmo" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-psiquiatria/btn.png');"></div>
        </div>
    </div>
    ...
    <div class="col-2">
        <div style="height: auto; background-color: #0094d6">
            <h2 class="texto-voce-sabia">
                Segundo os psiquiatras, mais de 90% dos casos de suicídio são
                totalmente evitáveis quando o paciente busca por ajuda.
            </h2>
        </div>
    </div>
    <div class="col-2">
