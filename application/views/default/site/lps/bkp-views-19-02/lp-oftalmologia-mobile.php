...
<!-- Banner -->
<div class="bg-lp-cardiologia-secao-1" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-oftalmologia/bg-secao1.jpg'); ">
    ...
    <div class="topo" style="position: relative">
        <div class="centraliza">
            <div class="col-2" style="margin-top: 100px; margin-right: 50px">
                ...
                <h1 style="color: white;font-size: 40px;">PROCURANDO<br>OFTALMOLOGISTA?</h1><br>
                ...
                <br>
                <a style="width: 300px;padding: 15px;font-size: 15px;background-color: white;border: 0px;border-radius: 10px;color: #7F1114;" class="animated infinite pulse" href="tel:+5514998361670"><img style="width: 20px; vertical-align: bottom;" src="<?= base_url(); ?>arquivos/assets/img/icone-telefone.png">  LIGUE AGORA PARA AGENDAR! </a>
                <br>
                <br>
                <br>
                <a style="width: 300px;padding: 15px;font-size: 15px;background-color: white;border: 0px;border-radius: 10px;color: #7F1114;" class="animated infinite pulse" href="https://wa.me/5514998361670"><img style="width: 20px; vertical-align: bottom;" src="<?= base_url(); ?>arquivos/assets/img/icone-whats.png">&nbsp;  AGENDE AGORA MESMO! </a>
            </div>
            <div class="clear"></div>
        </div>
    </div>
...
<div style="width: 100%;">
    ...
    <div class="col-2">
        ...
        <div style="height: auto; background-color: #ffffff">
            <div style="padding: 25px; margin-bottom: 40px;margin-top: 40px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Consulta Oftalmologista</h3></div>
            ...
            <div style="padding: 25px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Exame de Fundo de Olho</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$100,00</h3></div>
            </div>
            <hr style="margin-left: 80px;margin-right: 80px;margin-top: 20px;">
            <div style="padding: 25px" class="centraliza">
                <div class="col-2"><h3 style="color: #013575" class="text-align-center">Acuidade Visual</h3></div>
                <div class="col-2"><h3 style="color: #c20e1a" class="text-align-center">R$80,00</h3></div>
            </div>
            <div class="clear"></div>
            <div style="padding: 25px" class="centraliza-itens">
                <div style="background-color: #c20e1a;height: auto;padding: 10px;width: 250px;border-radius: 25px;">
                    ...
                    <div class="col-2"><h3 style="color: #ffffff;margin-top: 10px;margin-bottom: 10px;" class="text-align-center">R$480,00</h3></div>
                </div>
            </div>
            <div class="clear"></div>
        </div>
        <div style="height: 300px;margin-bottom: 20px;margin-right: 10px;background-repeat: no-repeat;background-position: center;background-size: contain; background-image: url('<?= base_url() ?>arquivos/assets/img/lp-oftalmologia/bg-print.png');"></div>
    </div>
    ...
    <div class="col-2">
        ...
        <div style="height: auto; background-color: #02428e;padding: 50px; color: #27c563;">
            <div class="centraliza">
                <h2>R$95,00</h2>
                <hr style="margin-right: 80px;margin-top: 20px;">
                <h2>Incluso no valor da consulta</h2>
                <hr style="margin-right: 80px;margin-top: 20px;">
                <h2>Incluso no valor da consulta</h2>
            </div>
            <div class="img-preco-oftalmo" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-oftalmologia/preco-sos.png');"></div>
            <div style="width: 150%">
                <a style="width: 300px;padding: 15px;font-size: 15px;background-color: white;border: 0px;border-radius: 10px;color: #7F1114;" class="animated infinite pulse" href="tel:+5514998361670"><img style="width: 20px; vertical-align: bottom;" src="<?= base_url(); ?>arquivos/assets/img/icone-telefone.png">  LIGUE AGORA PARA AGENDAR! </a>
                <br>
                <br>
    ...
    <div class="centraliza">
        <div class="centraliza-itens">
            <div style="margin-top: 30px; margin-bottom: 30px" class="col-4-icones">
                ...
                <h2 style="font-size: 20px; color: #02428e;">Mais de<br>10.000<br>pacientes<br>atendidos.</h2>
            </div>
            <div style="margin-top: 30px; margin-bottom: 30px" class="col-4-icones">
    ...
    <div class="col-2">
        <div style="height: auto; background-color: #0094d6">
            <h2 class="texto-voce-sabia">
                Entre 60% e 80% dos casos de cegueira no mundo, decorrentes de doenças, poderiam ter sido evitados ou têm tratamento. Não corra riscos! Agende já sua consulta!
            </h2>
        </div>
    </div>
    <div class="col-2">
        <div style="height: auto; background-color: #ffffff">
            <h2 style="color: #013069;font-size: 18px; margin-top: 20px" class="texto-voce-sabia">
                ...
                <div style="width: 150%">
                    <a style="width: 300px;padding: 15px;font-size: 15px;background-color: #7F1114;border: 0px;border-radius: 10px;color: #fff;" class="animated infinite pulse" href="tel:+5514998361670"><img style="width: 20px; vertical-align: bottom;" src="<?= base_url(); ?>arquivos/assets/img/icone-telefone-branco.png">  LIGUE AGORA PARA AGENDAR! </a>
                    <br>
                    <br>
                    <br>
                    <a style="width: 300px;padding: 15px;font-size: 15px;background-color: #7F1114;border: 0px;border-radius: 10px;color: #fff;" class="animated infinite pulse" href="https://wa.me/5514998361670"><img style="width: 20px; vertical-align: bottom;" src="<?= base_url(); ?>arquivos/assets/img/icone-whats-branco.png">&nbsp;  AGENDE AGORA MESMO! </a>
                </div>
...
<div style="width: 100%; height: auto; background-color: #013069">
    ...
    <div class="centraliza">
        ...
        <div style="margin-bottom: 30px; margin-top: 25px;height: auto; background-color: #013069">
            ...
            <div>
                <a style="text-decoration: none;" href="tel:5514998361670">
                    <img class="icones-contato" src="<?= base_url() ?>arquivos/assets/img/lp-cardiologia/icone-whats-novo.png">
                </a>
            </div>
    ...
    <div style="width: 100%; height: auto; background-color: #013473;">
        <div class="centraliza-itens">
            <h2 style="padding: 50px 0px 50px 0px;" class="texto-voce-sabia">
