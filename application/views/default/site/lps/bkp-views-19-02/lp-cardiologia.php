<?php $this->load->view("default/site/include/header-lp"); ?>
    ...
    <div class="rodape-fixo" style="position: fixed;bottom: 0px;left: 0px;width: 100%;z-index: 99; background-color: #27448a">
        <div style="padding: 20px" class="centraliza-itens">
            <a onclick="ModalLps('abre')" class="animated infinite pulse btn-agende-ja " style="width: 160px !important;padding: 17px !important;font-size: 13px !important;background-color: #c20e1a !important;border: 0px !important; border-radius: 10px !important;color: #ffffff !important;position: relative;left: -100px !important;"> AGENDE JÁ! </a>
        </div>
    </div>
