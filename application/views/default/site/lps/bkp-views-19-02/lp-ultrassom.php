...
<!-- Banner -->
<div class="bg-lp-cardiologia-secao-1" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-ultrassom/banner.png'); ">
    ...
    <div class="topo" style="position: relative">
        <div class="centraliza">
            <div class="col-2" style="margin-top: 100px; margin-right: 50px">
                ...
                <h1 style="color: white;font-size: 40px;">PRECISANDO<br>DE ULTRASSOM?</h1><br>
                ...
                <button onclick="ModalLps('abre')" style="width: 200px;padding: 20px;font-size: 15px;background-color: white;border: 0px;border-radius: 10px;color: #ef795f;" class="animated infinite pulse"> AGENDE JÁ! </button>
            </div>
            <div class="clear"></div>
        </div>
    </div>
...
<div style="width: 100%;">
    <div class="centraliza p-t-40 p-b-40">
       <div class="rolagem">
           <img src="<?= base_url() ?>arquivos/assets/img/lp-ultrassom/tabela.png" style="width: 1100px;" />
       </div> 
    </div>
</div>
<div class="clear"></div>
    ...
    <div class="col-2">
        <div style="height: auto; background-color: #0094d6">
            <h2 class="texto-voce-sabia">
                O ultrassom é muito importante na detecção de alterações mamárias variadas.
                Segundo o INCA, são mais de 57 mil novos casos de câncer de mama no país, que
                quando descoberto no início aumenta as chances de tratamentos eficazes e cura.
            </h2>
        </div>
    </div>
    <div class="col-2">
