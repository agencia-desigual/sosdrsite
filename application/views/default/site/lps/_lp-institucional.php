    ...
    <div class="topo" style="position: relative">
        <div class="centraliza">
            <div class="col-2" style="margin-top: 100px; margin-right: 50px">
                ...
                <h3 style="color: white;margin-right: 60px;font-weight: 100;">A partir de agora deixe conosco, que vamos cuidar de você e da sua sáude.</h3><br>
                <h3 style="color: white;margin-right: 60px;font-weight: bold;">CLIQUE ABAIXO PARA AGENDAR GRATUITAMENTE</h3><br>
                <button onclick="ModalLps('abre')" style="width: 100%; background: transparent; border: 0px;">
...
<div style="width: 100%; height: auto; background-color: #013069">
    ...
    <div style="margin-bottom: 0px;width: 100%; height: auto; background-color: #013473">
        <div class="centraliza-itens">
            <h2 style="padding: 50px 0px 50px 0px;" class="texto-voce-sabia">
