...
<style>
    ...
    <!-- Banner -->
    <div class="bg-lp-cardiologia-secao-1" style="margin-top:70px;background-image: url('<?= base_url() ?>arquivos/assets/img/lp-urologista/banner.png'); ">
        ...
        <div class="topo" style="position: relative">
            <div class="centraliza">
                <div class="col-2" style="margin-top: 100px; margin-right: 50px">
                    ...
                    <h1 style="color: white;font-size: 40px;">PROCURANDO<br>UROLOGISTA?</h1><br>
    ...
    <div style="width: 100%; display: none">
        <div class="centraliza p-t-40 p-b-40">
            <div class="rolagem">
                <img src="<?= base_url() ?>arquivos/assets/img/lp-urologista/tabela.png" style="width: 1100px;" />
                <div style="height: 300px;margin-bottom: 20px;margin-right: 10px;background-repeat: no-repeat;background-position: center;background-size: contain; background-image: url('<?= base_url() ?>arquivos/assets/img/lp-urologista/bg-print.png');"></div>
            </div>
        </div>
    </div>
    <div class="clear"></div>
        ...
        <div class="col-2">
            <div style="height: auto; background-color: #0094d6">
                <h2 class="texto-voce-sabia">
                    É importante realizar o exame para identificar o nível de testosterona no seu corpo. Você sabia que há mais de 25 milhões de homens no mundo que sofrem com a queda de testosterona e não falam nada?
                </h2>
            </div>
        </div>
        <div class="col-2">
