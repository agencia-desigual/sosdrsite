...
<div style="width: 100%;">
    ...
    <div class="col-2">
        <div class="bg-preco-ginecologista" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-oftalmologia/tabela.png');"></div>
    ...
    <div class="col-2">
        ...
        <div id="preco-img" style="height: auto; background-color: #02428e;padding: 50px; color: #27c563;">
            <div class="centraliza">
                <h2>R$95,00</h2>
            ...
            <div style="width: 150%">
                <a style="width: 300px;padding: 15px;font-size: 15px;background-color: white;border: 0px;border-radius: 10px;color: #7F1114;" class="animated infinite pulse" href="tel:+5514981610303"><img style="width: 20px; vertical-align: bottom;" src="<?= base_url(); ?>arquivos/assets/img/icone-telefone.png">  LIGUE AGORA PARA AGENDAR! </a>
                <br>
                <br>
                <br>
                <a style="width: 300px;padding: 15px;font-size: 15px;background-color: white;border: 0px;border-radius: 10px;color: #7F1114;" class="animated infinite pulse" href="https://wa.me/5514981610303"><img style="width: 20px; vertical-align: bottom;" src="<?= base_url(); ?>arquivos/assets/img/icone-whats.png">&nbsp;  AGENDE AGORA MESMO! </a>
            </div>
        </div>
    </div>
