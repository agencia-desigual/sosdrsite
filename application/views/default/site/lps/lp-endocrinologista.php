...
<style>
    ...
    <!-- Banner -->
    <div class="bg-lp-cardiologia-secao-1" style="margin-top:70px;background-image: url('<?= base_url() ?>arquivos/assets/img/lp-endocrinologista/banner.png'); ">
    ...
    <div style="width: 100%;display: none">
        ...
        <div class="col-2">
            <div class="bg-preco-ginecologista" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-endocrinologista/tabela.png');"></div>
            <div style="height: 300px;margin-bottom: 20px;margin-right: 10px;background-repeat: no-repeat;background-position: center;background-size: contain; background-image: url('<?= base_url() ?>arquivos/assets/img/lp-endocrinologista/bg-print.png');"></div>
        </div>
        ...
        <div class="col-2">
            ...
            <div id="preco-img" style="height: auto; background-color: #02428e;padding: 80px; color: #ffffff;">
                <h1>CONSULTA ENDOCRINO</h1>
                <h1>+ RETORNO</h1>
                <h1>+ PERFIL LIPÍCO</h1>
                <h1>+ GLICEMIA</h1>
                <h1>+ TSH</h1>
                <div class="img-preco-oftalmo" style="background-image: url('<?= base_url() ?>arquivos/assets/img/lp-endocrinologista/preco.png');"></div>
        ...
        <div class="col-2">
            <div style="height: auto; background-color: #0094d6">
                <h2 class="texto-voce-sabia">
                    O INCA estima que para cada
                    ano sejam diagnosticados
                    9.610 novos casos de câncer
                    de tireóide, sendo que o
                    diagnóstico precoce garante
