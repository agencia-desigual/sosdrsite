<?php
  ...
  class Newsletter_model extends CI_Model
  {
     ...
     */
      ...
      {
        $query = $this->db->insert("newsletter",$salva);
      ...
      {
        $query = $this->db->delete("newsletter",$where);
        return $query;
      ...
      {
        $query = $this->db->update("newsletter",$dados,$where);
        return $query;
      ...
      */
      ...
      public function get_video($where = null)
      {
        $query = $this->db->get_where("newsletter_video",$where);
        return $query->result();
      }
