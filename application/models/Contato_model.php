...
class Contato_model extends CI_Model
{
   ...
   */
    ...
    {
        $query = $this->db->get_where("painel_contato",$where);
    ...
    {
        $query = $this->db->insert("painel_contato",$salva);
    ...
    {
        $query = $this->db->delete("painel_contato",$where);
        return $query;
    ...
    {
        $query = $this->db->update("painel_contato",$dados,$where);
        return $query;
