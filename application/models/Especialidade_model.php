<?php
  ...
  class Especialidade_model extends CI_Model
  {
     ...
     */
      ...
      {
        $query = $this->db->get_where("especialidade",$where);
      ...
      {
        $this->db->order_by("Id_especialidade","DESC");
        $query = $this->db->get_where("especialidade",$where);
        return $query->result();
        /*
      ...
      {
        $query = $this->db->insert("especialidade",$salva);
      ...
      {
        $query = $this->db->delete("especialidade",$where);
        return $query;
      ...
      {
        $query = $this->db->update("especialidade",$dados,$where);
        return $query;
