<?php
  ...
  class Lead_model extends CI_Model
  {
     ...
     */
      ...
      {
        $query = $this->db->get_where("painel_lead",$where);
      ...
      {
        $query = $this->db->insert("painel_lead",$salva);
      ...
      {
        $query = $this->db->delete("painel_lead",$where);
        return $query;
      ...
      {
        $query = $this->db->update("painel_lead",$dados,$where);
        return $query;
