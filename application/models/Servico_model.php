...
class Servico_model extends CI_Model
{
   ...
   */
    ...
    {
        $query = $this->db->get_where("painel_servico",$where);
    ...
    {
        $query = $this->db->insert("painel_servico",$salva);
    ...
    {
        $query = $this->db->delete("painel_servico",$where);
        return $query;
    ...
    {
        $query = $this->db->update("painel_servico",$dados,$where);
        return $query;
