...
class Consulta_model extends CI_Model
{
   ...
   */
    ...
    {
        $query = $this->db->get_where("painel_ganhe_consulta",$where);
    ...
    {
        $query = $this->db->insert("painel_ganhe_consulta",$salva);
    ...
    {
        $query = $this->db->delete("painel_ganhe_consulta",$where);
        return $query;
    ...
    {
        $query = $this->db->update("painel_ganhe_consulta",$dados,$where);
        return $query;
