...
class Unidade_model extends CI_Model
{
   ...
   */
    ...
    {
        $query = $this->db->get_where("painel_unidades",$where);
    ...
    {
        $this->db->order_by("id_unidades","DESC");
        $query = $this->db->get_where("painel_unidades",$where);
        return $query->result();
        /*
    ...
    {
        $query = $this->db->insert("painel_unidades",$salva);
    ...
    {
        $query = $this->db->delete("painel_unidades",$where);
        return $query;
    ...
    {
        $query = $this->db->update("painel_unidades",$dados,$where);
        return $query;
