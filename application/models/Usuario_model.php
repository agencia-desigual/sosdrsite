...
class Usuario_model extends CI_Model
{
   ...
   */
    ...
    {
        $query = $this->db->get_where("painel_usuario",$where);
    ...
    {
        $query = $this->db->insert("painel_usuario",$salva);
    ...
    {
        $query = $this->db->delete("painel_usuario",$where);
        return $query;
    ...
    {
        $query = $this->db->update("painel_usuario",$dados,$where);
        return $query;
