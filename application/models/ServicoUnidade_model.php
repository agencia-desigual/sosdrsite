...
class ServicoUnidade_model extends CI_Model
{
   ...
   */
    ...
    {
        $query = $this->db->get_where("painel_unidade_servico",$where);
    ...
    {
        $this->db->order_by("id_unidade_servico","DESC");
        $query = $this->db->get_where("painel_unidade_servico",$where);
        return $query->result();
        /*
    ...
    {
        $query = $this->db->insert("painel_unidade_servico",$salva);
    ...
    {
        $query = $this->db->delete("painel_unidade_servico",$where);
        return $query;
    ...
    {
        $query = $this->db->update("painel_unidade_servico",$dados,$where);
        return $query;
