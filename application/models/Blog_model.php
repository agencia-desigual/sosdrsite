...
class Blog_model extends CI_Model
{
   ...
   */
    ...
    {
        $query = $this->db->get_where("painel_blog",$where);
    ...
    {
        $query = $this->db->insert("painel_blog",$salva);
    ...
    {
        $query = $this->db->delete("painel_blog",$where);
        return $query;
    ...
    {
        $query = $this->db->update("painel_blog",$dados,$where);
        return $query;
