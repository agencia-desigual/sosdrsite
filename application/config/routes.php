...
$route['gerar_excel_contatolp'] = "principal/gerarExcelContatoLP";

$route['agendamento'] = "principal/teste";
$route['agendamento/(:any)'] = "principal/teste/$1";
$route['agendamento/(:any)/(:any)'] = "principal/teste/$1/$2";

$route['medicinadotrabalho'] = "principal/index";

// 9 LPS NOVAS
$route['lp-laboratorio'] = "principal/lp_laboratorio";
$route['lp-endocrinologista'] = "principal/lp_endocrinologista";
$route['lp-ultrassom'] = "principal/lp_ultrassom";
$route['lp-gastro'] = "principal/lp_gastro";
$route['lp-ortopedia'] = "principal/lp_ortopedia";
$route['lp-urologia'] = "principal/lp_urologia";
$route['lp-psiquiatria'] = "principal/lp_psiquiatria";
$route['lp-otorrino'] = "principal/lp_otorrino";
$route['lp-neurologista'] = "principal/lp_neurologista";

$route['lp-exames'] = "principal/lp_exame";

// LP OTIMIZADA
$route['lp-telemedicina'] = "principal/lp_telemedicina";

// LP IMPLANTE
$route['lp-implante'] = "principal/lp_implante";
...
// $route['lp-institucional'] = "principal/lp_institucional";
...
$route['nova-quem-somos'] = "principal/novaQuemSomos";
...
$route['unidades'] = "principal/unidades";
$route['unidades/(:any)'] = "principal/unidadesBusca";
...
$route['ajax/whats'] = "ajax/cadastrarWhats";
$route['ajax/contato_lp'] = "ajax/contatoLP";
...
$route['painel/unidades'] = "painel/unidades";
$route['painel/unidades/editar/(:any)'] = "painel/unidadesEditar/$1";
$route['painel/ajax-editar-unidade'] = "painel/ajaxEditarUnidade";
$route['painel/unidades/cadastrar'] = "painel/unidadesCadastrar";
$route['painel/ajax-cadastrar-unidade'] = "painel/ajaxCadastrarUnidade";
$route['painel/ajax-excluir-unidade/(:any)'] = "painel/ajaxExcluirUnidade/$1";
$route['painel/ajax-excluir-unidade-servico/(:any)'] = "painel/ajaxExcluirUnidadeServico/$1";

$route['painel/usuarios'] = "painel/usuarios";
$route['painel/usuario/editar/(:any)'] = "painel/usuarioEditar/$1";
$route['painel/usuario/cadastrar'] = "painel/usuarioCadastrar";
$route['painel/ajax-editar-usuario'] = "ajax/ajaxEditarUsuario";
$route['painel/ajax-cadastrar-usuario'] = "ajax/ajaxCadastrarUsuario";
$route['painel/ajax-excluir-usuario/(:any)'] = "ajax/ajaxExcluirUsuario/$1";
...
$route['painel/leads'] = "painel/leads";
$route['lead-sucesso'] = "principal/leadSucesso";
$route['lead-delete'] = "ajax/leadDelete";
